    ...
    const experiences: Experience[] = [
      {
        ...
        startDate: '2024-08',
        endDate: 'Présent',
        description: 'Développement d\'applications web avec Angular et tailwind css. Lead technique sur plusieurs projets critiques.',
      ...
      },
      {
        ...
        startDate: '2024-06',
        endDate: '2024-12',
        description: 'Développement full stack d\'une plateforme de gestion des effets accademique. Mise en place de l\'architecture frontend et backend.',
      ...
      },
      {
        ...
        startDate: '2025-01',
        endDate: 'Présent',
        description: 'Développement de sites web responsive et applications mobiles hybrides.',
    ...
    const skillCategories: SkillCategory[] = [
      {
        ...
        skills: [
          ...
          { id: 2, name: 'Angular', level: 90, category: 'frontend' },
          { id: 3, name: 'TypeScript', level: 85, category: 'frontend' },
          { id: 4, name: 'HTML/CSS', level: 95, category: 'frontend' },
          { id: 5, name: 'Tailwind CSS', level: 88, category: 'frontend' },
          { id: 6, name: 'RxJS', level: 80, category: 'frontend' },
        ],
      },
      {
        name: 'Backend',
        skills: [
          ...
          { id: 8, name: 'Spring boot', level: 65, category: 'backend' },
          { id: 9, name: 'MysQL', level: 60, category: 'backend' },
        ],
      },
      {
        name: 'Outils & Autres',
        skills: [
          { id: 10, name: 'Git', level: 85, category: 'tools' },
          { id: 11, name: 'Docker', level: 70, category: 'tools' },
          { id: 12, name: 'Jest', level: 75, category: 'tools' },
          { id: 13, name: 'Figma', level: 65, category: 'tools' },
    ...
    const posts: BlogPost[] = [
      {
        ...
        excerpt: 'Découvrez les dernières fonctionnalités d\'Angular 18 et comment les utiliser dans vos projets.',
      ...
      },
      {
        ...
        excerpt: 'Maîtrisez Tailwind CSS pour créer des interfaces modernes et responsive.',
        content: 'Contenu complet de l\'article...',
        imageUrl: 'https://via.placeholder.com/600x400',
        author: 'Junior Gerome',
